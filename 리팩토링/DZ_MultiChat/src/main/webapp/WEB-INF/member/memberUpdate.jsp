...
<body class="sidebar-dark">
	<div class="main-wrapper">
		...
		<div class="page-wrapper">
			<nav class="navbar">
				...
				<div style="border: 1px solid; text-align: center; width: 600px; margin-left: auto; margin-right: auto;">
				<h1 style="text-align: center; margin-top: 40px;">회원 정보 수정</h1>
				<form style="width: 400px; margin-left: 30%">
					<fieldset>
						<ul>
							<li><label for="uid" id="uid" style="margin-left: -120px">아이디</label>
								${uid}</li>
	...
	/*    	if("pwd".eqauls(null)){
	    ...
	    fetch('/DZ_MultiChat/Member/memberUpdate.do', {
	    	//option
	    	method : 'POST',
	    	headers: {
