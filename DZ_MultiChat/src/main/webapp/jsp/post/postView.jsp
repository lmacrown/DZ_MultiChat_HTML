							...
							<div class="dropdown-menu" aria-labelledby="profileDropdown">
								...
								<div class="dropdown-body">
									<ul class="profile-nav p-0 pt-3">
										...
										<li class="nav-item"><a class="nav-link"
											href="/multichat/jsp/login.jsp"> <i data-feather="log-out"></i> <span>Log
													Out</span>
										</a></li>
									</ul>
								</div>
							...
							<div class="px-4 py-5" style="width: 100%">
								...
								<form style="width: 90%; margin-left: 10px">
									<div class="form-group">
										<label>작성자 : ${post.id}</label> <label
											style="float: right; margin-right: 10%">작성일 :
											${post.registDate}</label>
									</div>
									...
									<div>
										<label for="contents"
											style="width: 90%; min-height: 450px; border: 1px solid;">${post.content}</label>
										<!-- 	<input type="text"
